...
settlement QRIS. Phase 5 menambahkan extractor daftar transaksi tabular, karena "spreadsheet
transaction parser" pada plan.md §37 Phase 5 memerlukan baris laporan POS dan marketplace
terbaca lebih dulu sebelum dapat dinormalisasi menjadi transaksi.

Jenis dokumen di luar kelimanya belum punya extractor, dan itu dilaporkan secara eksplisit
sebagai `NoExtractorAvailable` alih-alih ditangani extractor terdekat. Memaksakan schema
faktur pada slip gaji akan menghasilkan field yang terisi tetapi salah arti, yang jauh lebih
berbahaya daripada dokumen yang jujur menunggu manusia.
"""
